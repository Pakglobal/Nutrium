...
const GetAccess = () => {
  ...
  const accessTextInfo = {
    ...
    subTitle:
      "Your practitioner can give you access after you're registered as their client.",
    subTitle1:
      "If you didn't recieve your sign in credentials from your practitioner, make sure to contact them and ask for acces to the Nutrium app.",
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: Color.white}}>
      ...
      <View style={{marginHorizontal: scale(20)}}>
        ...
        <Text style={[styles.subTitleFont, {marginTop: verticalScale(180)}]}>
          {accessTextInfo?.endText}
        </Text>
        <Button
