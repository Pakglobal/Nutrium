...
const UnlockAccess = () => {
  ...
  const gymTextData = {
    ...
    subTitle: "You just need to completed a few step before you can start your nutrition journey:",
    step1: "1. Open your Gympass app",
    step2: "2. Go to 'all Apps'",
    step3: "3. Click on Nutrium and then Activate",
    step4: "4. You'll be redirected to this app and you\n      just have to created a new account",
    endText: "Just follow these steps and start enjoying all your Nutrium care perks, including appointments with experts."
  }
  return (
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{ marginHorizontal: scale(20) }}>
          ...
          <View style={{ marginLeft: verticalScale(5), marginTop: scale(10) }}>
            ...
            <Text style={[styles.subTitleFont, { marginTop: verticalScale(5) }]}>{gymTextData?.endText}</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
