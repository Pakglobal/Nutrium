...
//                         <AntDesign name='close' size={25} color={Color?.black} style={{}} />
//                     </TouchableOpacity>
//                     {/* Icon Circle */}
//                     <View style={[styles.iconContainer, {
//                         borderColor: type === 'success' ? '#26B8872B' : '#F246462B',
//                         backgroundColor: type === 'success' ? '#26B88789' : '#F246462B',
//                         // backgroundColor: type === 'success' ? 'rgba(33, 151, 43, 0.1)' : 'rgba(255, 0, 0, 0.1)'
//                     }]}>
//                         {/* <Text style={[styles.xIcon, { color: type === 'success' ? '#21972b' : 'red' }]}>
//                             {type === 'success' ? '✓' : '×'}
//                         </Text> */}

//                         <AntDesign name='close' size={25} color={'#F24646'} style={{ color: type === 'success' ? '#21972b' : 'red' }} />
//                     </View>

//                     <Text style={[styles.title, { color: type === 'success' ? Color?.black : Color?.textColor }]}>
//                         {type === 'success' ? 'Success!' : 'Error!'}
//                     </Text>
...
//                     <TouchableOpacity
//                         style={[styles.button, {
//                             borderColor: type === 'success' ? '#26B887' : '#F24646'
//                         }]}
//                         onPress={onClose}
//                     >
//                         <Text style={[styles.buttonText, { color: type === 'success' ? '#26B887' : '#F24646' }]}>
//                             {type === 'success' ? 'OK' : 'OK'}
//                         </Text>
//                     </TouchableOpacity>
//                 </View>
