          ...
          <View style={styles.cardContainer}>
            ...
            {mealName ? (
              <View
                ...
                <Text style={{ color: Color.black, fontFamily: Font?.Poppins }}>{mealName}</Text>
                <TouchableOpacity
        ...
        <View
          ...
          <View style={styles.cardContent}>
            <View style={{}}>
              ...
              <Text style={{ color: Color.gray, fontFamily: Font?.Poppins }}>Add a photo of your meal</Text>
            </View>
            ...
            <CustomShadow color={Color?.gray} >
              <View style={styles.commentContent}>
                <TextInput
                  ...
                  multiline={true}
                  style={{ fontSize: scale(12), color: Color?.textColor, fontFamily: Font?.Poppins }}
                  value={comments}
